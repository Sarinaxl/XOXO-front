...
function Login(){
    ...
    function LoginOrCreateUser(){
        ...
        axios.post('http://127.0.0.1:8000/Players',player1).then((response) =>{setPlayer1(response.data)})


        axios.post('http://127.0.0.1:8000/Players',player2).then((response) =>{setPlayer2(response.data)})
